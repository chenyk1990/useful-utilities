...
\begin{figure}[htb!]
  \centering
    \subfloat[]{\includegraphics[width=0.11\textwidth]{hyper/Fig/hyper}
    \label{fig:hyper}}
    \subfloat[]{\includegraphics[width=0.11\textwidth]{hyper/Fig/hyper0}
    \label{fig:hyper0}}    
  \subfloat[]{\includegraphics[width=0.11\textwidth]{hyper/Fig/hyper-zero}
    \label{fig:hyper-zero}}\\
    \subfloat[]{\includegraphics[width=0.11\textwidth]{hyper/Fig/hyper-seis}
    \label{fig:hyper-seis}}
  \subfloat[]{\includegraphics[width=0.11\textwidth]{hyper/Fig/hyper-fx}
    \label{fig:hyper-fx}}
  \subfloat[]{\includegraphics[width=0.11\textwidth]{hyper/Fig/hyper-seisvd}
...
\begin{figure}[htb!]
  \centering
  \subfloat[]{\includegraphics[width=0.11\textwidth]{hyper/Fig/hyper-seis-dif}
    \label{fig:hyper-seis-dif}}
    \subfloat[]{\includegraphics[width=0.11\textwidth]{hyper/Fig/hyper-fx-dif}
    \label{fig:hyper-fx-dif}}
    \subfloat[]{\includegraphics[width=0.11\textwidth]{hyper/Fig/hyper-seisvd-dif}
...
\begin{figure}[htb!]
  \centering
    \subfloat[]{\includegraphics[width=0.14\textwidth]{hyper/Fig/snrs-pocs}
    \label{fig:snrs-pocs}}
  \subfloat[]{\includegraphics[width=0.14\textwidth]{hyper/Fig/snrs-pocsvd}
...
\begin{figure}[htb!]
  \centering
    \subfloat[]{\includegraphics[width=0.10\textwidth]{hyper/Fig/hyper-sdip}
    \label{fig:hyper-sdip}}
  \subfloat[]{\includegraphics[width=0.10\textwidth]{hyper/Fig/hyper-pdip}
    \label{fig:hyper-pdip}}
    \subfloat[]{\includegraphics[width=0.10\textwidth]{hyper/Fig/hyper-dipiter}
    \label{fig:hyper-dipiter}}
    \subfloat[]{\includegraphics[width=0.10\textwidth]{hyper/Fig/hyper-vdip}
...
\begin{figure}[htb!]
  \centering
    \subfloat[]{\includegraphics[width=0.11\textwidth]{hypern/Fig/hyper-n}
    \label{fig:hyper-n}}
    \subfloat[]{\includegraphics[width=0.11\textwidth]{hypern/Fig/hyper0-n}
    \label{fig:hyper0-n}}    
  \subfloat[]{\includegraphics[width=0.11\textwidth]{hypern/Fig/hyper-zero-n}
    \label{fig:hyper-zero-n}}\\
    \subfloat[]{\includegraphics[width=0.11\textwidth]{hypern/Fig/hypern-seis}
    \label{fig:hypern-seis}}
  \subfloat[]{\includegraphics[width=0.11\textwidth]{hypern/Fig/hypern-fx}
    \label{fig:hypern-fx}}
  \subfloat[]{\includegraphics[width=0.11\textwidth]{hypern/Fig/hypern-seisvd}
...
\begin{figure}[htb!]
  \centering
  \subfloat[]{\includegraphics[width=0.11\textwidth]{hypern/Fig/hypern-seis-dif}
    \label{fig:hypern-seis-dif}}
    \subfloat[]{\includegraphics[width=0.11\textwidth]{hypern/Fig/hypern-fx-dif}
    \label{fig:hypern-fx-dif}}
    \subfloat[]{\includegraphics[width=0.11\textwidth]{hypern/Fig/hypern-seisvd-dif}
...
\begin{figure*}[ht!]
  \centering
    \subfloat[]{\includegraphics[width=0.125\textwidth]{bei/Fig/bei}
    \label{fig:bei}}   
  \subfloat[]{\includegraphics[width=0.125\textwidth]{bei/Fig/bei-zero}
    \label{fig:bei-zero}}
  \subfloat[]{\includegraphics[width=0.125\textwidth]{bei/Fig/vscan}
    \label{fig:vscan}}  \\
  \subfloat[]{\includegraphics[width=0.115\textwidth]{bei/Fig/bei-pdip}
    \label{fig:bei-pdip}}        
  \subfloat[]{\includegraphics[width=0.115\textwidth]{bei/Fig/bei-vdip}
    \label{fig:bei-vdip}}     
  \subfloat[]{\includegraphics[width=0.115\textwidth]{bei/Fig/bei-fx}
    \label{fig:bei-fx}}
  \subfloat[]{\includegraphics[width=0.115\textwidth]{bei/Fig/bei-seisvd}
...
\begin{figure*}[ht!]
  \centering
    \subfloat[]{\includegraphics[width=0.115\textwidth]{bei/Fig/fk-bei}
    \label{fig:fk-bei}}   
  \subfloat[]{\includegraphics[width=0.115\textwidth]{bei/Fig/fk-bei-zero}
    \label{fig:fk-bei-zero}}
  \subfloat[]{\includegraphics[width=0.115\textwidth]{bei/Fig/fk-bei-fx}
    \label{fig:fk-bei-fx}}
  \subfloat[]{\includegraphics[width=0.115\textwidth]{bei/Fig/fk-bei-seisvd}
...
\begin{figure}[htb!]
  \centering
    \subfloat[]{\includegraphics[width=0.12\textwidth]{bei/Fig/bei-seis-bp}
    \label{fig:bei-seis-bp}}
  \subfloat[]{\includegraphics[width=0.12\textwidth]{bei/Fig/bei-dif-bp}
    \label{fig:bei-dif-bp}}\\
    \subfloat[]{\includegraphics[width=0.12\textwidth]{bei/Fig/fk-bei-seis-bp}
    \label{fig:fk-bei-seis-bp}}       
    \subfloat[]{\includegraphics[width=0.12\textwidth]{bei/Fig/fk-dif-bp}
    \label{fig:fk-dif-bp}}       
