...
\begin{figure}[htb!]
	\centering
	\subfloat[]{\includegraphics[width=0.4\textwidth]{hyp3d_2/Fig/hyp3d-c}  \label{fig:hyp3d-c}}
    \subfloat[]{\includegraphics[width=0.4\textwidth]{hyp3d_2/Fig/hyp3d-n}	\label{fig:hyp3d-n}}\\
	\caption{Synthetic \wen{data} examples with hyperbolic events. (a) Clean \dlo{synthetic }data. (b) Noisy\dlo{ synthetic} data. \wen{The gray scales for all of the images shown in Figures \ref{fig:hyp3d-cn}-\ref{fig:hyp3d-9-comp-s} are the same.}}
	\label{fig:hyp3d-cn}
\end{figure}

\begin{figure*}[ht!]
	\centering
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-fk}   \label{fig:hyp3d-fk}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-lr}	  \label{fig:hyp3d-lr}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-dlr}  \label{fig:hyp3d-dlr}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-olr}  \label{fig:hyp3d-olr}}\\
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-n-fk}   \label{fig:hyp3d-fk}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-n-lr}	  \label{fig:hyp3d-lr}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-n-dlr}  \label{fig:hyp3d-dlr}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-n-olr}  \label{fig:hyp3d-olr}}\\
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-simi1}   \label{fig:hyp3d-simi1}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-simi2}	  \label{fig:hyp3d-simi2}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-simi3}  \label{fig:hyp3d-simi3}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_2/Fig/hyp3d-simi4}  \label{fig:hyp3d-simi4}}\\
...
\begin{figure*}[ht!]
	\centering
	\subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_2/Fig/hyp3d-c-fkk}   \label{fig:hyp3d-c-fkk}}
	\subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_2/Fig/hyp3d-n-fkk}   \label{fig:hyp3d-n-fkk}}
    \subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_2/Fig/hyp3d-fk-fkk}	  \label{fig:hyp3d-fk-fkk}}\\
    \subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_2/Fig/hyp3d-lr-fkk}	  \label{fig:hyp3d-lr-fkk}}
	\subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_2/Fig/hyp3d-dlr-fkk}  \label{fig:hyp3d-dlr-fkk}}
    \subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_2/Fig/hyp3d-olr-fkk}  \label{fig:hyp3d-olr-fkk}}
...
\begin{figure*}[ht!]
	\centering
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-fk}   \label{fig:hyp3d-9-fk}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-lr}	  \label{fig:hyp3d-9-lr}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-dlr}  \label{fig:hyp3d-9-dlr}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-olr}  \label{fig:hyp3d-9-olr}}\\
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-n-fk}   \label{fig:hyp3d-9-fk}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-n-lr}	  \label{fig:hyp3d-9-lr}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-n-dlr}  \label{fig:hyp3d-9-dlr}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-n-olr}  \label{fig:hyp3d-9-olr}}\\
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-simi1}   \label{fig:hyp3d-9-simi1}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-simi2}	  \label{fig:hyp3d-9-simi2}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-simi3}  \label{fig:hyp3d-9-simi3}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-simi4}  \label{fig:hyp3d-9-simi4}}\\
	...
	\label{fig:hyp3d-9-comp}
\end{figure*}

\begin{figure*}[ht!]
	\centering
	\subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-c-fkk}   \label{fig:hyp3d-9-c-fkk}}
	\subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-n-fkk}   \label{fig:hyp3d-9-n-fkk}}
    \subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-fk-fkk}	  \label{fig:hyp3d-9-fk-fkk}}\\
    \subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-lr-fkk}	  \label{fig:hyp3d-9-lr-fkk}}
	\subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-dlr-fkk}  \label{fig:hyp3d-9-dlr-fkk}}
    \subfloat[]{\includegraphics[width=0.3\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-olr-fkk}  \label{fig:hyp3d-9-olr-fkk}}
	...
	\label{fig:hyp3d-9-comp-fk}
\end{figure*}


\begin{figure*}[ht!]
	\centering
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-c-s}   \label{fig:hyp3d-9-c-s}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-fk-s}   \label{fig:hyp3d-9-fk-s}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-lr-s}	  \label{fig:hyp3d-9-lr-s}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-dlr-s}  \label{fig:hyp3d-9-dlr-s}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-olr-s}  \label{fig:hyp3d-9-olr-s}}\\
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-n-s}   \label{fig:hyp3d-9-n-s}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-n-fk-s}   \label{fig:hyp3d-9-fk-s}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-n-lr-s}	  \label{fig:hyp3d-9-lr-s}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-n-dlr-s}  \label{fig:hyp3d-9-dlr}-s}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-n-olr-s}  \label{fig:hyp3d-9-olr-s}}\\
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-simi1-s}   \label{fig:hyp3d-9-simi1-s}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-simi2-s}	  \label{fig:hyp3d-9-simi2-s}}
	\subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-simi3-s}  \label{fig:hyp3d-9-simi3-s}}
    \subfloat[]{\includegraphics[width=0.18\textwidth]{hyp3d_N9_2/Fig/hyp3d-9-simi4-s}  \label{fig:hyp3d-9-simi4-s}}\\
	\caption{Denoising comparison (\dlo{$N=10$}\wen{$N=20$}). \dlo{(a) Clean data. (b) Result using the FK thresholding method. (c) Result using the rank-reduction method. (d) Result using the damped rank-reduction method. (e) Result using the proposed method. (f) Noisy data. (g) Removed noise using the FK thresholding method. (h) Removed noise using the rank-reduction method. (i) Removed noise using the damped rank-reduction method. (j) Removed noise using the proposed method.}\wen{(b)-(e): denoised results using FK method, (b) rank-reduction method, (c) damped rank-reduction method, and the proposed method, respectively. (f) Noisy data. (g)-(j) Separated noise corresponding to (b)-(e), respectively. (k)-(n) Local similarity corresponding to (b)-(e), respectively. }}
	\label{fig:hyp3d-9-comp-s}
\end{figure*}
