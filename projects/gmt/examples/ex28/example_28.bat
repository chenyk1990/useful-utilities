REM		GMT EXAMPLE 28
REM		$Id: example_28.bat 15178 2015-11-06 10:45:03Z fwobbe $
REM
...
gmt psbasemap -R -J -O -K -Lg155:07:30W/19:15:40N+c19:23N+f+jTC+w5k+l1:16,000+u --FONT_ANNOT_PRIMARY=10p --FONT_LABEL=10p >> %ps%
