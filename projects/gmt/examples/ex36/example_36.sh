...
grdimage tt.nc -JH0/6i -Bag -Ctt.cpt -P -Xc -Y7.25i -K > $ps
psxy -Rg -J -O -K mars370.txt -Sc0.05i -G0 -B30g30 -Y-3.25i >> $ps
# Smoothing
sphinterpolate mars370.txt -Rg -I1 -Q3 -Gtt.nc
grdimage tt.nc -JH0/6i -Bag -Ctt.cpt  -Y-3.25i -O -K -V >> $ps
