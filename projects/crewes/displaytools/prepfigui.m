%PREPFIGUI ... usuful utility to make presentation quality figures
% PREPFIGUI calls the following utilities:
%   bigfig,bigfont,boldlines(gcf,4,2),whitefig 
% It differs from prepfig in that UI controls are not hidden
