function scell=num2strcell(vec,sigfig)
% NUM2STRCELL: convert a vector of numbers to a cell array of strings
%
...
% ************** default =4 **************
%
% Converts a vector of numbers to a cell vector of strings. Thus scell{k}=num2str(vec(k),sigfig).
%
