function seismix=tvtracemix(seis,t,tweights,weights)
% TVTRACEMIX ... time variant weighted trace mixing on a seismic gather or section
%
% seismix=tvtracemix(seis,t,tweights,weights)
%
