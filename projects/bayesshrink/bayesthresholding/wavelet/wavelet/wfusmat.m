...
%
%   The matrices A and B must be of same size. The output matrix C
%   is of the same size as A and B.
%
...
%   $Revision: 1.1.6.2 $  $Date: 2004/03/15 22:42:53 $ 
...
switch lower(methName)
    ...
    case 'ud_fusion' , 
        try , t = method.param; catch , t = 1; end
        S = size(A);
        x  = linspace(0,1,S(1));
        P = zeros(S);
