...
%   $Revision: 1.13 $ $Date: 2002/06/17 12:18:55 $
...
switch option
    case 'clean'
        ...
        if nargin<4 , in4 = ''; end
        str_btn = 'Analyze';
        cba_btn = ['wp2dmngr(''anal'',' sprintf('%.0f',win_wptool) ');'];
    ...
    case 'set_gui'
        ...
        switch in3
            ...
            case 'anal'
                Level_Anal = wmemtool('rmb',win_wptool,n_param_anal,...
                                                        ind_lev_anal);
        ...
        switch in3
            case {'load_img','demo','load_dec'}
                ...
                [ pos_axe_pack,   pos_axe_tree,   pos_axe_cfs,    ...
                  ...
                  pos_axe_col] =  wpposaxe(win_wptool,2,pos_g,Img_Size);
