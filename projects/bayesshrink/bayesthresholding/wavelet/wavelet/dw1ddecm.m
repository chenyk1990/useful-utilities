...
switch option
    ...
    case 'view'
        ...
        [v_flg,ccfs_m] = dw1dvmod('get_vm',win_dw1dtool,2);
        ...
        for k =level:-1:1
            str_tit = [str_tit ' + d' int2str(k)];
        end
        str_tit = [str_tit ' .'];
        wtitle(str_tit,'Parent',axeAct);
