...
%     table_node(i) =-1   if the node which indice is i-1 doesn't exist
%     table_node(i) = i-1 if the node which indice is i-1 exists
%     if depth-pos is (d,b) , i = (order^d-1)/(order-1)+b
%   txtstr = matrix wich contains the string of the children of the node.
