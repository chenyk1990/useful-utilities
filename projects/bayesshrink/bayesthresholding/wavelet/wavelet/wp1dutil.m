...
%   $Revision: 1.12 $ $Date: 2002/06/17 12:19:03 $
...
m_files      = wfigmngr('getmenus',win_wptool,'file');
...
switch option
    case 'clean'
        ...
        str_btn = 'Analyze';
        cba_btn = ['wp1dmngr(''anal'',' sprintf('%.0f',win_wptool) ');'];
        ...
        %------------------------------------
        set([m_savesyn,m_savedec],'Enable','Off');
    ...
    case 'set_gui'
        ...
        switch in3
            ...
            case 'anal'
                Lev_Anal = wmemtool('rmb',win_wptool,n_param_anal,ind_lev_anal);
         end
        switch in3
            case {'load_sig','demo','load_dec'}
                pos_g = wmemtool('rmb',win_wptool,n_wp_utils,ind_gra_area);
                [nul, nul, nul, nul, pos_sli_size, pos_sli_pos, nul] = ...
                                wpposaxe(win_wptool,1,pos_g);
    ...
    case 'enable'
        ...
        switch in3
            case {'demo','load_dec','anal','synt'}
                ...
                set([m_savesyn , m_savedec],'Enable','on');
