...
/*<       SUBROUTINE ZEBC(INPUT,OUTPUT,NCHAR) >*/
#ifdef __STDC__
/* Subroutine */ int zebc(char *ainput, char *aoutput, integer nchar)
#else
/* Subroutine */ int zebc(ainput, aoutput, nchar)
...
/*     CONVERT NCHAR CHARACTERS FROM ASCII TO EBCDIC */
