...
echo "%selfdocs.tex --- complete list of CWP Free program selfdocs" >> $FILE
		...
		echo " " >> $FILE
		echo "\\documentclass[12pt]{article}" >> $FILE
		echo " " >> $FILE
		echo -n "\\" >> $FILE ; echo "textwidth 6.25in" >> $FILE
		echo -n "\\" >> $FILE ; echo "textheight 8.75in" >> $FILE
		echo "\\oddsidemargin .125in" >> $FILE
		echo "\\evensidemargin .125in" >> $FILE
		echo -n "%\\" >> $FILE; echo "topmargin -.5in" >> $FILE
		echo " " >> $FILE
#
#		echo -n "\\"; echo "title{Complete Listing of CWP Free" >> $FILE 
...
#		echo "\\date{\\""\\today}" >> $FILE
		...
		echo -n "\\" >> $FILE ; echo "begin{document}" >> $FILE
#		echo "\\maketitle " >> $FILE
...
## above and comment out the next line
		...
		echo >> $FILE
		echo -n "\\" >> $FILE ; echo "begin{verbatim}" >> $FILE
