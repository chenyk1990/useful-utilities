cy    modify the code to fullfill the output format requirement of
cy    matlab
...
cy      print*,' .... reading all maps ... ' 
      ...
      close(54)
 1    continue
cy      print*,'enter center lat, long of desired tile (q to quit)' 
...
c make sure longitudes go from -180 to 180
      ...
      ilat=90.-flat+1
      ilon=180.+flon+1
cy      print 102,'ilat,ilon,crustal type: ',ilat,ilon
 102  format(a,2i4)
cy      print*,'topography: ',bnd(1,ilat,ilon)
      print*,bnd(1,ilat,ilon),0,0,0
cy      print*,' layers: vp,vs,rho,bottom'
 103  format(4f7.2)
      do i=1,np-1
         print 103,vp(i,ilat,ilon),vs(i,ilat,ilon),rho(i,ilat,ilon),
     +          bnd(i+1,ilat,ilon) 
      enddo
cy      print 104,' pn,sn,rho-mantle: ',vp(9,ilat,ilon),
cy     +         vs(9,ilat,ilon),rho(9,ilat,ilon)
 104  format(a,3f7.2)
cy      goto 1
 99   continue
      end
